...
# this part has ValueError: setting an array element with a sequence. The requested array would exceed the maximum number of dimension of 1.
# but the best_confg has been saved, so it is alright
lib.dump_json(
